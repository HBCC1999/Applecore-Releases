...
| `E` / `H` / `U` | Set difficulty | Easy / Hard / Ultra Hard (medium is default) |
| `Enter` | Start game | Press on home page |
| `ESC` | Pause / Resume | Most keybinds disabled while paused |
| `Home` | Return to home page | Available from game over screen |
| `V` / `C` | Increase / Decrease speed | |
| `X` / `Z` | Increase / Decrease growth factor | Applied after eating an apple |
...
# History
First version was released on August 2024. Though it is not available now.
Applecore 2.0 was subsequently released within a week of 1.0
Applecore 3.0 came in January 1st, 2025.
Significant updates on August 2025.
Even more significant updates in March and April of 2026.
Current update 3.6 was launched in April.

# Setup/Installation
Download the latest .exe from the releases page, place it anywhere on your computer, and double-click to launch.
